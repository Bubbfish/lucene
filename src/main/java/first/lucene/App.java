 ...
 */
public class App{
    private static App indexManager;
    private static String content="";
    
    private static String INDEX_DIR = "F:\\luceneIndea";
     ...
     * @return 返回索引管理器对象
     */
    public App getManager(){
        if(indexManager == null){
            this.indexManager = new App();
        }
        return indexManager;
    }
    /**
    ...
    public static boolean createIndex(String path){
        ...
        for (File file : fileList) {           //foreach
            content = "";
            //获取文件后缀
 ...
 //           System.out.println("content :"+ content);
            ...
            try{
                ...
                directory = FSDirectory.open(new File(INDEX_DIR));//本地文件存储
